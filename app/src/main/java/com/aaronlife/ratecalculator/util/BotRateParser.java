    ...
    private RateData getRateCsvData(String csvAddress)
    {
        ...
        try
        {
            ...
            while((line = reader.readLine()) != null)
            {
                ...
                {
                    case RateData.USD: rd.usd = val; break;
                    case RateData.EUR: rd.eur = val; break;
                    case RateData.JPY: rd.jpy = val; break;
                    case RateData.KRW: rd.krw = val; break;
                    case RateData.HKD: rd.hkd = val; break;
                    case RateData.IDR: rd.idr = val; break;
                    case RateData.CNY: rd.cny = val; break;

                    case RateData.GBP: rd.gbp = val; break;
                    case RateData.AUD: rd.aud = val; break;
                    case RateData.CAD: rd.cad = val; break;
                    case RateData.SGD: rd.sgd = val; break;
                    case RateData.CHF: rd.chf = val; break;
                    case RateData.ZAR: rd.zar = val; break;
                    case RateData.SEK: rd.sek = val; break;
                    case RateData.NZD: rd.nzd = val; break;
                    case RateData.THB: rd.thb = val; break;
                    case RateData.PHP: rd.php = val; break;
                    case RateData.VND: rd.vnd = val; break;
                    case RateData.MYR: rd.myr = val; break;
                }
            }
        }
        catch(IOException e)
